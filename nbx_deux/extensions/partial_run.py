...
NOTE: If the error does not happen in the correct context i.e. the
error is thrown in library code, the scope returned might not be
worthwhile.

You can make a function with @run_as_main which defines the scope
partialrun will pull from when it errors.
"""
import sys
